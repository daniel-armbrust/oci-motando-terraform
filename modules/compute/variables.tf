...
variable "baseline_ocpu_utilization" {
    ...
    validation {
       condition = can(regex("^(BASELINE_1_1|BASELINE_1_2|BASELINE_1_8)$", var.baseline_ocpu_utilization))
       error_message = "The baseline OCPU utilization must be: BASELINE_1_1, BASELINE_1_2 or BASELINE_1_8."
    }   
}
